...
public class MainActivity extends AppCompatActivity implements MyPopularMovieAdapter.MyPopularMovieAdapterOnClickHandler{
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            ...
            case R.id.action_sortPopular:
                Toast.makeText(context,"Sort Popular", Toast.LENGTH_SHORT).show();
                Log.d(TAG, "onOptionsItemSelected: sort by popular ");
                //TODO call client to sort data by popular
                loadMovieData(Constants.POPULARITY_PARAM);
                return true;

            case R.id.action_sortRating:
                Toast.makeText(context,"Sort Rating", Toast.LENGTH_SHORT).show();
                Log.d(TAG, "onOptionsItemSelected: sort by rating ");
                //Todo call client to sort data by rating
    ...
    private boolean checkInternetConnection(Context context) {
        ...
        if (cm.getActiveNetworkInfo() != null
            ...
            Toast.makeText(context,"Internet Connection Not Present", Toast.LENGTH_SHORT).show();
            return false;
        }
    }
    ...
    public void onClick(PopularMovies myMovie) {
        Log.d(TAG, "onClick: " + myMovie.getTitle());
    ...
    public class FetchPopulaMovie extends AsyncTask<String, Void, List<PopularMovies>> {
       ...
       protected List<PopularMovies> doInBackground(String... params) {
           ...
           if (params.length == 0) {
               Log.d(TAG, "doInBackground: NO REQUEST DATA PASSED IN ");
               return null;
           }
           ...
           Log.d(TAG, "doInBackground: RETURN URL" + popularMovieRequestUrl);
       ...
       protected void onPostExecute(List<PopularMovies> popularMovies) {
           ...
           Log.i(TAG, "onPostExecute: here is size of movies.." + popularMovies.size());
